package com.example.gd12_pdf_b_10789
...
import com.example.gd12_pdf_b_10789.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama:String,umur:String,tlp:String,alamat:String,kampus:String){
        ...
        val file = File(pdfPath,"pdf_10789.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.udon)
